...
// Components
const Checkbox = require('./components/settings/checkbox')
const ColorPicker = require('./components/settings/colorpicker')
const ThemeSelect = require('./components/settings/theme')
